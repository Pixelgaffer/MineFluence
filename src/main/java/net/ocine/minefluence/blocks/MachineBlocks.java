...
public class MachineBlocks extends BlockContainer {
            ...
            if (side == 2) {
                ...
                if (tileEntity != null) {
                    if (tileEntity instanceof TileEntityDisplay) {
                        ...
                        if (progress < 90) return display3;
                        if (progress < 100) return display4;
                        return display5;
                    }
                }
                return displayFront;
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        display0 = iconRegister.registerIcon("minefluence:mblock_display_front_frame0");
        display1 = iconRegister.registerIcon("minefluence:mblock_display_front_frame1");
        display2 = iconRegister.registerIcon("minefluence:mblock_display_front_frame2");
