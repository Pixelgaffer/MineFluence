...
public class MachineBlockOutput extends BlockContainer {

	public static final String NAME = "machineBlockOutput";

	public static final PropertyEnum PROP_BORDER = PropertyEnum.create("border", IMachinePart.BorderType.class);

	public MachineBlockOutput(CreativeTabs tab) {
		super(Material.iron);
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		...
		((InventoryTileEntity) world.getTileEntity(pos)).dropItems(world, pos.getX(), pos.getY(), pos.getZ());
